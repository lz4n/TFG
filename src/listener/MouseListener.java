      ...
      if (action == GLFW.GLFW_PRESS) {
          ...
          if (button == GLFW.GLFW_MOUSE_BUTTON_1) {
              ...
              if (MouseListener.inGameLocation.getFeature() == null) {
                  Main.WORLD.setFeature((int) MouseListener.inGameLocation.getX(), (int) MouseListener.inGameLocation.getY(), new Tree(MouseListener.inGameLocation));
                  MouseListener.inGameLocation.getFeature().getFeatureType().updateMesh();
              }
          }
