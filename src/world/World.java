...
public class World extends Thread {
    ...
    private Terrain generateTerrain(int x, int y) {
        ...
        switch (biome) {
            case FOREST:
                if (World.RANDOM.nextFloat() >= 0.75) new Tree(new Vector2d(x + World.RANDOM.nextDouble() /4, y + World.RANDOM.nextDouble() /4));
                else if (World.RANDOM.nextFloat() >= 0.8) new Bush(new Vector2d(x, y + World.RANDOM.nextDouble() /2));
                break;
            case PLAINS:
                if (World.RANDOM.nextFloat() >= 0.97) new Tree(new Vector2d(x + World.RANDOM.nextDouble() /2, y + World.RANDOM.nextDouble() /4));
                else if (World.RANDOM.nextFloat() >= 0.6) new Bush(new Vector2d(x, y + World.RANDOM.nextDouble() /2));
                break;
        }
