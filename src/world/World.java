...
public class World extends Thread {
    ...
    public final Map<Feature.FeatureType, TreeSet<Feature>> FEATURES_MAP = new TreeMap<>();
    private int dayTime;
    ...
    public void setFeature(int x, int y, Feature feature, boolean updateMesh) {
        try {
            FEATURE[this.mapCoordinatesToIndex(x, y)] = feature;
            Feature.FeatureType featureType = feature.getFeatureType();
            TreeSet<Feature> featureSet = FEATURES_MAP.getOrDefault(featureType, new TreeSet<>());
            featureSet.add(feature);
            FEATURES_MAP.put(featureType, featureSet);
