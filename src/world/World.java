...
public class World {
    ...
    private Terrain generateTerrain(int x, int y) {
        ...
        switch (biome) {
            case FOREST:
                if (World.RANDOM.nextFloat() >= 0.7) FEATURES.add(new Tree(new Vector2d(x + World.RANDOM.nextDouble() /2, y + World.RANDOM.nextDouble() /2)));
                else if (World.RANDOM.nextFloat() >= 0.8) FEATURES.add(new Bush(new Vector2d(x, y + World.RANDOM.nextDouble() /2)));
                break;
            case PLAINS:
                if (World.RANDOM.nextFloat() >= 0.99) FEATURES.add(new Tree(new Vector2d(x + World.RANDOM.nextDouble() /2, y + World.RANDOM.nextDouble() /2)));
