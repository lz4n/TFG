...
public class WorldBuilder {
    ...
    private final float ROUGHNESS = 0.4f, SCALE = 0.5f;
    private final NoiseGenerator CONTINENTALITY_NOISE, WEIRDNESS_NOISE;

    public WorldBuilder(int seed) {
        this.CONTINENTALITY_NOISE = new NoiseGenerator(seed) {{SetNoiseType(NoiseType.OpenSimplex2);}};
        this.WEIRDNESS_NOISE = new NoiseGenerator(0) {{SetNoiseType(NoiseType.OpenSimplex2);}};
    }
